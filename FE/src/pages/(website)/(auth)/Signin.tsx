...
const Signin = () => {
    ...
    const handleLogin = (data: FieldType) => {
        login(data)
    }
    return (
        <div className='container'>
            {contextHolder}
            <div className="py-9 h-[100vh]">
                <div className="h-[100%] my-auto flex justify-center bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    <div
                    ...
                    <div className="w-full px-8 py-1 lg:w-1/2">
                        ...
                        <div className="max-w-md w-full py-6">
                            ...
                            <h1 className="text-sm mt-10 font-semibold mb-6 text-gray-500 text-center">Join to Our Community with all time access and free </h1>
