                        ...
                        <div className="lg:gap-x-6 mb:gap-x-4 lg:-translate-x-[60px] mb:-translate-x-[22px]">
                            {
                                user
                                    ? (
                                        <>
                                            {/* <span className="text-sm">Helle <strong>{user?.email}</strong></span> */}
                                            <Dropdown menu={{ items }}>
                            ...
                            |<Link to={'/cart'}>
                                <button className="h-[24px]">
                                    ...
                                    {
                                        count != 0 && (
                                            <span className="absolute bg-red-500 top-2 rounded-[50%] w-[16px] h-[16px] text-xs text-white">{count}</span>
                                        )
                                    }
