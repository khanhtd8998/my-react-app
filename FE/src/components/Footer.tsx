    ...
    return (
        <>
            <footer className="w-full lg:-mt-1 bg-gradient-to-b from-[#1A1E26] to-[#01100B]">
                <div className="relative lg:pt-[403px] mt-64 mb:pt-[271px] lg:w-[1200px] mb:w-[342px] mx-auto">
                    {/* UNLOCK VOUCHER 20% */}
                    <div className="lg:w-[1200px] lg:left-0 lg:translate-x-0 w-full mb:left-1/2 mb:-translate-x-1/2 absolute top-0 -translate-y-[50%]">
